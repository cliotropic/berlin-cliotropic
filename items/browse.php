	...
	<div id="primary">
		...
		<?php while (loop_items()): ?>
			<div class="item hentry">    
				...
				<?php if ($text = item('Item Type Metadata', 'Text', array('snippet'=>1000))): ?>					
    				<div class="item-description">
    				<p><?php echo $text; ?></p>
    				</div>
				<?php elseif ($description = item('Dublin Core', 'Description', array('snippet'=>1000))): ?>
    				<div class="item-description">
    				<?php echo $description; ?>
    				</div>
				<?php elseif ($description == ''): ?>
					<div class="item-description none-yet">
